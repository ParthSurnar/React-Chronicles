        ...
        <>
            <div className='font-nosifer text-soft-neon flex justify-center items-center pt-7 text-center container mx-auto flex-col'>
                <h1 className='text-4xl  mx-auto'>
                    L0GIN TO GET YOUR Fans Support YOU
                </h1>
                ...
                <div className="flex flex-col gap-2 [] p-10">
                    ...
                    <button
                        className="flex items-center hover:shadow-[0_0_20px_rgba(160,32,240,1)] transition duration-150 ease-in-out  border border-[#FF44CC] rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-soft-neon  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
